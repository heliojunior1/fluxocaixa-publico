...
Funcionalidade: Classificação da staging em lançamentos
  ...
  Cenário: Linha que casa com um item vira lançamento
    Dado o mapeamento 2026 tipo "1" de "SIS_P" com o item "1.1.1" e regra "Natureza começa com '1112'"
  ...
  Cenário: Tipo é derivado do sinal do valor efetivo
    ...
    Dado o mapeamento 2026 tipo "2" de "SIS_P" com o item "1.1.1" e regra "Natureza começa com '2222'"
    Quando processo o mapeamento
    Então os lançamentos têm origem "Automático" e tipo "Saída"

  Cenário: Inversão de sinal é aplicada
    Dado o mapeamento 2026 tipo "1" de "SIS_P" com o item "1.1.1" e regra "Natureza começa com '1112'" com inversão
    Quando processo o mapeamento
    Então os lançamentos do qualificador "1.1.1" têm valores negativos

  Cenário: Inversão de sinal vale também para despesa
    Dado o mapeamento 2026 tipo "2" de "SIS_P" com o item "1.1.1" e regra "Natureza começa com '1112'" com inversão
    Quando processo o mapeamento
    Então os lançamentos do qualificador "1.1.1" têm valores negativos

  Cenário: Linha que casa com dois itens vira erro explícito
    Dado o mapeamento 2026 tipo "1" de "SIS_P" com dois itens que casam com a mesma linha
    Quando processo o mapeamento
  ...
  Cenário: Linha com valor zero não gera lançamento
    ...
    E o mapeamento 2026 tipo "1" de "SIS_P" com o item "1.1.1" e regra "Natureza começa com '1112'"
    Quando processo o mapeamento

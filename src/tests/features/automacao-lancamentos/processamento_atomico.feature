...
Funcionalidade: Processamento atômico e resync no escopo do mapeamento
  ...
  Cenário: Falha ao marcar a linha desfaz o lançamento
    Dado o mapeamento 2061 tipo "1" de "SIS_Q1A" com o item "61.1" e regra "Natureza começa com '1112'"
  ...
  Cenário: Resync não alcança outro exercício
    ...
    E o mapeamento 2061 tipo "1" de "SIS_Q1A" com o item "61.1" e regra "Natureza começa com '1112'"
    E o mapeamento 2062 tipo "1" de "SIS_Q1A" com o item "61.1" e regra "Natureza começa com '1112'"
  ...
  Cenário: Resync não alcança outro sistema de origem
    ...
    E o mapeamento 2061 tipo "1" de "SIS_Q1A" com o item "61.1" e regra "Natureza começa com '1112'"
    E o mapeamento 2061 tipo "1" de "SIS_Q1B" com o item "61.1" e regra "Natureza começa com '1112'"
    E que já processei os dois mapeamentos

...
A tela **Contas Bancárias** (menu Movimentação, abaixo de Fundos) permite cadastrar, alterar, inativar e reativar contas. A tripla banco/agência/conta fica **imutável** quando a conta já tem saldos ou lançamentos vinculados (corrija criando a conta certa e inativando a errada — o histórico é preservado), e a inativação é bloqueada enquanto houver saldo ativo.
